...
public class ProductRepositoryDAOImpl implements ProductRepositoryDAO {
	...
	public Product getProductById(String productID) {
		...
		*/
		...
		Product foundProductById = listOfProducts.stream().filter(predicate).findAny().orElse(null);
	...
	public List<Product> getProductsByCategory(String category) {
		...
		*/
		...
		Predicate<Product> predicate = (Product p ) -> p.getCategory().equalsIgnoreCase(category);
	...
	public List<Product> getProductsByBrands(List<String> brands) {
		 ...
		 * Old Way
		 * 
		 * List<Product> productsByBrands = new ArrayList<Product>();
		...
		*/
		...
		Predicate<Product> predicate = (Product p) -> brands.contains(p.getManufacturer().toLowerCase());
		List<Product> filtered = listOfProducts.stream().filter(predicate).collect(Collectors.toList());
		return filtered;
	}
