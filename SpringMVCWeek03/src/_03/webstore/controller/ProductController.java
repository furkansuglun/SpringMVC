...
public class ProductController {
	...
	public String listProductsByCategory(@PathVariable("productCategory") String productCateory  , Model model) {
		model.addAttribute("products", productService.getProductsByCategory(productCateory));
		return "03.webstore.view/productList";
	}
