...
<link rel="stylesheet" type="text/css" media="screen" href="<c:url value="/web/resources/css/bootstrap.min.css" />" />
<script src="<c:url value="/web/resources/js/bootstrap.min.js" />"></script>
<script src="<c:url value="/web/resources/js/jquery.min.js" />"></script>
